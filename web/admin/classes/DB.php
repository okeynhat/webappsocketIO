<!-- thư viện xử lý CSDL quản trị viên -->
...
class DB
{
    ...
    private $hostname = 'remotemysql.com', //địa chỉ máy chủ CSDL
            $username = '6USK3AZfQS',//tên tài khoản CSDL
            $password = 'ZVQMeUMsfJ',//mật khẩu CSDL
            $dbname = '6USK3AZfQS';//tên CSDL
